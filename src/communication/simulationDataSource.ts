...
import { SimulationEngine, type SimulationCommand } from '../simulation/simulationEngine'
...
export class SimulationDataSource extends BaseDataSource {
  ...
  constructor(mode: OperatingMode = 'SIMULATION') {
...
function modeName(mode: OperatingMode): string {
