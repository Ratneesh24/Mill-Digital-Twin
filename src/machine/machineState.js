...
export function entryReel(state) {
...
export function exitReel(state) {
...
export function entryGauge(state) {
...
export function exitGauge(state) {
...
export function entryReelId(direction) {
    return payoffReel(direction);
}
export function exitReelId(direction) {
...
export function isThreaded(state) {
