...
function ChevronRun({ sideX }) {
    ...
    return (_jsxs("instancedMesh", { ref: meshRef, args: [undefined, undefined, CHEVRONS_PER_SPAN], children: [_jsx("coneGeometry", { args: [0.055, 0.13, 4] }), _jsx("meshStandardMaterial", { transparent: true, opacity: 0.4, depthWrite: false })] }));
}
