...
export const millConfig = {
    ...
    visual: {
         ...
         */
        cameraHome: [4.5, 5.0, -13.5],
        cameraTarget: [-2.2, 0.1, 0],
        /**
         ...
         */
        cameraStand: [1.1, 0.6, -2.9],
        cameraStandTarget: [0, 0.05, 0],
        /**
         ...
         */
        cameraEntry: [-4.2, 3.2, -7.5],
        cameraEntryTarget: [-6.6, 0, 0],
        cameraFov: 36,
 ...
 */
const MANUAL = 'Confirmed — FPE O&M manual';
const ASSUMED = 'Assumed — CONFIRM with mill engineering';
export const PLANT_PARAMETERS = [
    {
        key: 'millType',
        label: 'Mill type',
