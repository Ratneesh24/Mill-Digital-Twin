 ...
 */
export function coilRadiusFromLength(
...
export function coilLengthFromRadius(
  mandrelRadiusMm: number,
  stripThicknessMm: number,
 ...
 */
export function reelRPM(lineSpeedMpm: number, coilRadiusMm: number): number {
 ...
 */
export function lengthAfterReduction(
  lengthM: number,
