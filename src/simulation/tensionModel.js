 ...
 */
export function calculateTensionReferences(entrySpecificTension, exitSpecificTension, inputThickness, outputThickness, width) {
 ...
 */
export function stepTension(current, reference, dt) {
 ...
 */
export function tensionReferenceForState(fullReferenceKN, speedMpm, threaded) {
    if (!threaded)
        return 0;
